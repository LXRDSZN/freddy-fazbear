...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 150, -1, 40));
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
         if (loginAttempts < 4) {
            ...
            if (isValidLogin(username, password)) {
                ...
                loginAttempts++;
                JOptionPane.showMessageDialog(this, "Inicio de sesión fallido. Intento " + loginAttempts, "LOGIN", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Demasiados intentos. Saliendo del programa.", "LOGIN", JOptionPane.WARNING_MESSAGE);
            dispose();
        }
